...
Under modulation : m<1, Em < Ec Critical modulation: m-1, Em = Ec Over modulation: m>1, Em > Ec Algorithm:
...
ma (Theory) = am/ac =0.5 ma(Practical) = (Emax-Emin)/(Emax+Emin) =0.5 MODEL GRAPH image
